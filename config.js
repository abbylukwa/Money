...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || "YOURBOT;YourName;https://example.com/image.jpg",
    WORKTYPE: process.env.WORKTYPE || "public",
    PREFIX: process.env.PREFIX || "[.,!]",
    PERSONAL_MESSAGE: process.env.PERSONAL_MESSAGE || "null",
    BOT_PRESENCE: process.env.BOT_PRESENCE || "unavailable",
    AUDIO_DATA: process.env.AUDIO_DATA || "YOURBOT;YourName;https://example.com/image.jpg",
    STICKER_DATA: process.env.STICKER_DATA || "YourBot;YourName",
    LIST_TYPE: process.env.LIST_TYPE || 'poll',
    LINK_PREVIEW: process.env.LINK_PREVIEW || 'YourBot;YourName;https://example.com/image.jpg',
